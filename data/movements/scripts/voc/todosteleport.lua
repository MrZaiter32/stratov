...
if getPlayerVocation(cid) == 5 and getPlayerLevel(cid) >= 30 and isPremium(cid) == TRUE then
...
if getPlayerVocation(cid) == 6 and getPlayerLevel(cid) >= 80 and isPremium(cid) == TRUE then
...
if getPlayerVocation(cid) == 7 and getPlayerLevel(cid) >= 80 and isPremium(cid) == TRUE then
...
if getPlayerVocation(cid) == 8 and getPlayerLevel(cid) >= 80 and isPremium(cid) == TRUE then
