...
function onThink() npcHandler:onThink()end
        ...
        local talkUser = NPCHANDLER_CONVBEHAVIOR == CONVERSATION_DEFAULT and (cid)
        if(not npcHandler:isFocused(cid))then
                return false
        elseif msgcontains(msg,"yes")and talkState[talkUser]==1then
                npcHandler:say("Great! I'll reward you greatly {ok}?.", cid)
                talkState[talkUser]=2
        elseif msgcontains(msg,"ok")and talkState[talkUser]==2then
        ...
        elseif msgcontains(msg,"mission")then
                ...
                elseif(str ==3)then
                        ...
                        doPlayerAddOutfit(cid, getPlayerSex(cid)==0and142or134,2)
