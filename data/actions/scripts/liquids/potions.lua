...
local POTIONS = {
	...
	[7588] = {empty = 7634, level = 30, splash = 2, health = {350, 400}, mana = {100, 150}, vocations = {4, 8, 12, 16, 20, 24, 28, 32,1, 5, 9, 13, 17, 21, 25, 29, 2 , 6, 10, 14, 18, 22, 26, 30, 3, 7,24, 11, 15, 19, 23, 27, 31}, vocStr = "sorcerers, druids , paladins and Provocs"}, -- strong health potion
	[7589] = {empty = 7634, level = 30, splash = 7, health = {100, 150}, mana = {350, 400}, vocations = {4, 8, 12, 16, 20, 24, 28, 32,1, 5, 9, 13, 17, 21, 25, 29, 2 , 6, 10, 14, 18, 22, 26, 30, 3, 7,24, 11, 15, 19, 23, 27, 31}, vocStr = "sorcerers, druids , paladins and Provocs"}, -- strong mana potion
	
	[7591] = {empty = 7635, level = 80, splash = 2, health = {600, 800}, mana = {200, 250}, vocations = {4, 8, 12, 16, 20, 24, 28, 32, 3, 7, 11, 15, 19, 23, 27, 31}, vocStr = "knights and paladins"}, -- great health potion
	[7590] = {empty = 7635, level = 80, splash = 7, health = {200, 250}, mana = {600, 800}, vocations = {1, 5, 9, 13, 17, 21, 25, 29, 2 , 6, 10, 14, 18, 22, 26, 30, 3, 7,24, 11, 15, 19, 23, 27, 31}, vocStr = "sorcerers, druids , paladins and Provocs"}, -- great mana potion
