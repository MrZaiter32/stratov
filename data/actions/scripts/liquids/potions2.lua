...
local POTIONS = {
	...
	[7590] = {empty = 7635, level = 90, splash = 7, health = {200, 250}, mana = {600, 800}, vocations = {1, 5, 9, 13, 17, 21, 25, 29, 2 , 6, 10, 14, 18, 22, 26, 30, 3, 7,24, 11, 15, 19, 23, 27, 31}, vocStr = "sorcerers, druids , paladins an Provocs"}, -- great mana potion
	...
	[16126] = {empty = 7635, level = 150, splash = 3, health = {400, 400}, mana = {1000, 1500}, vocations = {3,7,11,15,19,23}, vocStr = "Paladin"} -- ultimate spirit potion
}
