-- The OTX Server Config
	...
	-- Owner Data
	ownerName = "Dinoxx & Sorairei"
	ownerEmail = "email@email.com"
	url = "https://mapacheot.sytes.net"
	location = "Monterrey"

	-- Messages
	motd = "Welcome to MapacheOT!"
	serverName = "MapacheOT"
	loginMessage = "Welcome to MapacheOT!"
	...
	-- Party System
	experienceShareRadiusX = 20
	experienceShareRadiusY = 20
	experienceShareRadiusZ = 1
	experienceShareLevelDifference = 2 / 3
	extraPartyExperienceLimit = 20
	extraPartyExperiencePercent = 60
